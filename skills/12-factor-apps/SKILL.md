...
> **Source & attribution.** Ported from the **`12-factor-apps`** skill by **anderskev**,
> published on clawhub.ai (<https://clawhub.ai/anderskev/12-factor-apps>), released under
> **MIT-0**. Methodology: [The Twelve-Factor App](https://12factor.net) by Adam Wiggins.
> See `ATTRIBUTION.md`.
